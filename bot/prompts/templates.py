...
def get_prompt_for_day(day):
    ...
    return f"You are a helpful frontend mentor. {base_prompt} Make it engaging, viral, easy to understand, and end with a question. Also include relevant hashtags"
